        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                ...
                >
                    ...
                    >
                        <h6 class="dark:text-white">Gallery table</h6>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-6 overflow-x-auto">
                            <div class="flex justify-between h-10">
                                ...
                                <Link :href="route('dashboard.gallery.create')">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-if="props.galleries.data.length"
                                        v-for="(gallery, index) in filteredData"
                                        :key="index"
                                    >
                                        <td
                    ...
                    <Pagination
                        ...
                        v-model:current-page="props.galleries.current_page"
...
const filteredData = computed(() => {
    return props.galleries.data.filter((unit) =>
...
const deleteData = (typeId) => {
    if (confirm("are you sure?")) {
        router.delete(route("dashboard.gallery.destroy", typeId), {
            preserveScroll: true,
        });
    }
};
...
function fetchTypes(page) {
    router.visit(`/gallery?page=${page}`);
}
</script>

            ...
            <div class="flex-none w-full max-w-full px-3">
                ...
                >
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-6 overflow-x-auto">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-if="props.categories.data.length"
                                        v-for="(category, index) in filteredCat"
                                        :key="index"
                                    >
                                        <td
                    ...
                    <Pagination
                        ...
                        v-model:current-page="props.categories.current_page"
...
const filteredCat = computed(() => {
    return props.categories.data.filter((unit) =>
...
const deleteData = (typeId) => {
    if (confirm("are you sure?")) {
        router.delete(route("dashboard.categories.destroy", typeId), {
            preserveScroll: true,
        });
    }
};
...
function fetchTypes(page) {
    router.visit(`/categories?page=${page}`);
}
</script>

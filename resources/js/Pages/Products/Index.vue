        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                ...
                >
                    ...
                    >
                        <h6 class="dark:text-white">Products table</h6>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-6 overflow-x-auto">
                            <div class="flex justify-between h-10">
                                ...
                                >
                                    <Button type="button" variant="#0088FE"
                                        >Create new</Button
                                    >
                                </Link>
                            </div>
                    ...
                    <Pagination
                        ...
                        v-model:current-page="props.products.current_page"
...
const filteredData = computed(() => {
    return props.products.data.filter((unit) =>
...
const deleteData = (typeId) => {
    if (confirm("are you sure?")) {
        router.delete(route("dashboard.products.destroy", typeId), {
            preserveScroll: true,
        });
    }
};
